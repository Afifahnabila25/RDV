...
if not df_weather.empty:
    fig_scatter = px.scatter(
        ...
        labels={'temp_mean_c': 'Rata-rata Suhu Harian (°C)', 'total_trips': 'Total Perjalanan (Trips)', 'weather_category': 'Kondisi'},
...
if not df_holiday.empty:
    # Mengubah boolean menjadi teks label display
    ...
    fig_holiday = px.bar(
        ...
        y='total_trips',
        color='Status Hari',
        labels={'total_trips': 'Jumlah Perjalanan'},
        color_discrete_map={'Hari Libur Nasional': '#e74c3c', 'Hari Kerja Biasa': '#2ecc71'}
    )
