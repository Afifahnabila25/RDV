...
st.set_page_config(
    page_title="NYC Taxi Analysis | Kelompok 4", page_icon="🚕", layout="wide"
)
...
taxi_filter = st.sidebar.multiselect(
    "Jenis Taksi", ["yellow", "green"], default=["yellow", "green"]
)
year_filter = st.sidebar.multiselect(
    "Tahun", [2023, 2024, 2025, 2026], default=[2023, 2024, 2025, 2026]
)

# Navigasi halaman
page = st.sidebar.radio("Halaman", ["Overview", "Revenue & Region", "Time & External"])
